            ...
            <form method="POST" action="{{ route('outlets.store') }}" accept-charset="UTF-8">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="telefon" type="text" class="form-control{{ $errors->has('telefon') ? ' is-invalid' : '' }}" name="telefon" value="{{ old('telefon', request('telefon')) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone', request('phone')) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="desc" class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}" name="desc" rows="4">{{ old('desc') }}</textarea>
